...
<div class="container mt-3">
    <div class="row">
        <div class="col-lg-6">
            <div class="card flex-md-row mb-4 box-shadow h-md-250">
                ...
                <img class="card-img-right flex-auto d-none d-md-block" data-src="holder.js/200x250?theme=thumb" alt="Thumbnail [200x250]" style="width: 300px; height: auto;" src="<?php echo constant('URL') ?>public/images/cocina.jpg" data-holder-rendered="true">
            </div>
        </div>
        <div class="col-lg-6">
            <div class="card flex-md-row mb-4 box-shadow h-md-250">
                <img class="card-img-left flex-auto d-none d-md-block" data-src="holder.js/200x250?theme=thumb" alt="Thumbnail [200x250]" style="width: 300px; height: auto;" src="<?php echo constant('URL') ?>public/images/casa_test.png" data-holder-rendered="true">
                <div class="card-body d-flex flex-column align-items-start">
    ...
    <div class="row">
            ...
            <div class="col-lg-6">
                <div class="card flex-md-row mb-4 box-shadow h-md-250">
                    <img class="card-img-left flex-auto d-none d-md-block" data-src="holder.js/200x250?theme=thumb" alt="Thumbnail [200x250]" style="width: 300px; height: auto;" src="<?php echo constant('URL') ?>public/images/patrimonio_test.png" data-holder-rendered="true">
                    <div class="card-body d-flex flex-column align-items-start">
